...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	  UPDATE_USERNAME: function UPDATE_USERNAME() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changeBtn = __webpack_require__(11);

	var _changeBtn2 = _interopRequireDefault(_changeBtn);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\changeBtn.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-a67a3c98/changeBtn.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./changeBtn.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./changeBtn.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// <template lang="html">
	//   <div>
	//     <button @click="updateUserName">set name</button>
	//     <h1>{{userName}}</h1>
	//   </div>
	// </template>
	//
	...
	exports.default = {
	  ...
	  vuex: {
	    actions: {
	      updateUserName: _actions.update_name
	    },
	    getters: {
...
/***/ function(module, exports) {
	...
	// 这里是分发动作
	var update_name = exports.update_name = function update_name(_ref) {
	  var dispatch = _ref.dispatch;

	  dispatch("UPDATE_USERNAME");
	};
